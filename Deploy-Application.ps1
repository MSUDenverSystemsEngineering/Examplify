...
Try {
	...
	[string]$appVendor = 'ExamSoft'
	[string]$appName = 'Examplify'
	[string]$appVersion = '2.4.0'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '08/13/2020'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-Process -Path "Examplify_2.4.0_win.exe" -Parameters "/S /v/qn" -PassThru -WindowStyle "Hidden" -WaitForMsiExec
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-MSI -Action 'Uninstall' -Path '{BDF34D34-009D-4567-84C6-77F898C3F031}'
